...
<html>
	...
	<body>
		...
		<?php
			...
			//This query gets all the players that are asked for acordding to the users input in the search bar
			$query = 'SELECT * FROM player P WHERE P.lastName LIKE \''.$_POST['search'].'\' OR P.firstName LIKE \''.$_POST['search'].'\';';
